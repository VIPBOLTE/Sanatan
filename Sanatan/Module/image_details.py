...
from Sanatan import Updater, CommandHandler, MessageHandler, Filters, CallbackContext
...
async def image_details(update: Update, context: CallbackContext) -> None:
    if update.message.reply_to_message and update.message.reply_to_message.photo:
        ...
        details_link = f"https://sasta-api.vercel.app/googleImageSearch={photo_url}"
